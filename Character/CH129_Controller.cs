...
{
    public class CH129_Controller : CharacterControlBase, ITangerineLogicUpdate
    {
                ...
                switch (curSubStatus)
                {
                    ...
                    case OrangeCharacter.SubStatus.SKILL0_3:
                        if (this.nowFrame >= this.endFrame)
                        {
                            ...
                            Tangerine.Utils.Il2CppHelpers.FxManagerPlay(this.FX_0_00, this._refEntity.AimTransform.position, OrangeCharacter.NormalQuaternion);
                            return;
                        }
                        break;
                    ...
                    default:
                        ...
                        if (!this.isSkillEventEnd && this.nowFrame >= this.skillEventFrame)
                        {
                            ...
                            Tangerine.Utils.Il2CppHelpers.FxManagerPlay(this.FX_1_00, this._refEntity.PlayerSkills[1].ShootTransform[0].position, (this._refEntity.direction == 1) ? OrangeCharacter.NormalQuaternion : OrangeCharacter.ReversedQuaternion);
                            return;
                        }
                        if (this.isSkillEventEnd && this.nowFrame >= this.endBreakFrame)
                        {
        ...
        {
            StartCoroutine(this.OnToggleRegularEffect(true, 0.6f).WrapToIl2Cpp());
        }
        ...
        {
            this.ToggleRegularEffect(false);
            StartCoroutine(OnToggleRegularEffect(true, 0.6f).WrapToIl2Cpp());
        }
        ...
        protected void StageTeleportOutCharacterDepend()
        {
            ...
            {
                StartCoroutine(OnToggleRegularEffect(true, 0.2f).WrapToIl2Cpp());
                return;
            }
