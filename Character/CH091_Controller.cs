...
namespace MonHunCollabRestored.Character
{
    public class CH091_Controller : CharacterControlBase
    {
        ...
        private void InitEnhanceSkill()
        {
            ...
            int skillId = (new int[] { 17101, 17102, 17103, 17104 })[this._enhanceSlot];
        ...
        public override void OverrideDelegateEvent()
        {
            ...
            this._refEntity.TeleportInCharacterDependEvt = (Callback)new System.Action(this.TeleportInCharacterDepend);
            ...
            this._refEntity.GuardHurtEvt = (Callback<HurtPassParam>)new System.Action<HurtPassParam>(this.GuardHurt);
            ...
            if (mainStatus == OrangeCharacter.MainStatus.SKILL)
            {
                switch (subStatus)
                {
                    ...
                    case OrangeCharacter.SubStatus.SKILL0_4:
                        ...
                        this.chargeFx = Tangerine.Utils.Il2CppHelpers.FxManagerPlayReturn<FxBase>(this.sFxuse000_EX3_0, this.shootPointTransform2, (this._refEntity.direction == 1) ? OrangeBattleUtility.QuaternionNormal : OrangeBattleUtility.QuaternionReverse);
                        return;
                    case OrangeCharacter.SubStatus.SKILL0_5:
                        Tangerine.Utils.Il2CppHelpers.FxManagerPlay(this.sFxuse000_EX3_1, this.shootPointTransform2.position, this.shootPointTransform2.rotation);
                    ...
                    default:
                        switch (subStatus)
                        {
                            case OrangeCharacter.SubStatus.SKILL1:
                                ...
                                this.UpdateCustomWeaponRenderer(true, true);
                                this.counterFx = Tangerine.Utils.Il2CppHelpers.FxManagerPlayReturn<FxBase>(this.sFxuse001_0, this._refEntity.ModelTransform.position, (this._refEntity.direction == 1) ? OrangeBattleUtility.QuaternionNormal : OrangeBattleUtility.QuaternionReverse);
                                return;
                            ...
                            case OrangeCharacter.SubStatus.SKILL1_3:
                                ...
                                this.UpdateCustomWeaponRenderer(true, true);
                                Tangerine.Utils.Il2CppHelpers.FxManagerPlay(this.sFxuse001_1, this.shootPointTransform2, OrangeBattleUtility.QuaternionNormal);
                                break;
                            default:
                                return;
                        }
        ...
        public void GuardHurt(HurtPassParam tHurtPassParam)
        {
            ...
            {
                this._refEntity.tRefPassiveskill.HurtTrigger(ref tHurtPassParam.dmg, this._refEntity.GetCurrentWeaponObj().weaponStatus.nWeaponCheck, ref this._refEntity.selfBuffManager, new Action<SKILL_TABLE>(this._refEntity.CreateBulletByLastWSTranform));
            }*/
        ...
        {
            return new Il2CppReferenceArray<Il2CppStringArray>(new Il2CppStringArray[] {
        ...
        private readonly int[] arrGuardCondtion = new int[] { 1205, 1206 };
