...
{
    public class CH107_Controller : CharacterControlBase, ITangerineLogicUpdate
    {
        ...
        public override void PlayerPressSkillCharacterCall(int id)
        {
            ...
            else
            {
                ...
                this.fxUseSkl2 = Tangerine.Utils.Il2CppHelpers.FxManagerPlayReturn<FxBase>(this.fxuse_skl1, this._refEntity.ModelTransform, Quaternion.identity);
        ...
        private void RefreashLightningFx(bool play)
        {
            if (this.fxLightning != null)
            {
                ...
                if (!play)
                {
                    Tangerine.Utils.Il2CppHelpers.FxManagerPlay(this.fx_lightning_stop, this._refEntity.ModelTransform, Quaternion.identity);
                }
            }
            if (play)
            {
                this.fxLightning = Tangerine.Utils.Il2CppHelpers.FxManagerPlayReturn<FxBase>(this.fx_lightning, this._refEntity.ModelTransform, Quaternion.identity);
            }
        }
