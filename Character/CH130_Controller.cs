...
{
    public class CH130_Controller : CharacterControlBase, ITangerineLogicUpdate
    {
        ...
        private void InitializeSkill()
        {
            ...
            if (ManagedSingleton<OrangeDataManager>.Instance.SKILL_TABLE_DICT.TryGetNewValue(this.sklFrenzyId, out skill_TABLE))
            {
                ...
                if (skill_TABLE.n_LINK_SKILL != 0 && ManagedSingleton<OrangeDataManager>.Instance.SKILL_TABLE_DICT.TryGetNewValue(skill_TABLE.n_LINK_SKILL, out this.linkSklPassive))
                {
                    ...
                    MonoBehaviourSingleton<PoolManager>.Instance.CreatePoolBase<ShieldBullet>("prefab/bullet/" + this.linkSklPassive.s_MODEL, this.linkSklPassive.s_MODEL, 3, (Callback)(new System.Action(this.PreloadLinkComplete)));
                }
            }
            ...
            this._FrenzyEffect[0] = OrangeBattleUtility.FindChildRecursive(componentsInChildren, "fxduring_barrage_000_L", true).GetComponent<ParticleSystem>();
            this._FrenzyEffect[1] = OrangeBattleUtility.FindChildRecursive(componentsInChildren, "fxduring_barrage_000_R", true).GetComponent<ParticleSystem>();
        ...
        public override void OverrideDelegateEvent()
        {
            ...
            this._refEntity.TeleportOutCharacterDependEvt = (Callback)new System.Action(this.TeleportOutCharacterDepend);
        ...
        private void PlayTeleportOutEffect()
        {
            ...
            Tangerine.Utils.Il2CppHelpers.FxManagerPlay("FX_TELEPORT_OUT", p_worldPos, Quaternion.identity);
        }
        ...
        private void PlayFrenzyFx()
        {
            ...
            Tangerine.Utils.Il2CppHelpers.FxManagerPlay(this.FX_2_00, this._refEntity.AimTransform.position, OrangeCharacter.NormalQuaternion);
                ...
                if (curSubStatus != OrangeCharacter.SubStatus.SKILL0)
                {
                    switch (curSubStatus)
                    {
                        case OrangeCharacter.SubStatus.SKILL1:
                            ...
                            {
                                bool bRushSkillReady = false;
                                if (this._refEntity.IsLocalPlayer)
                                {
                                    bRushSkillReady = true;
                                }
                                ...
                                {
                                    WeaponStruct weaponStruct = this._refEntity.PlayerSkills[1];
                                    this._refEntity.PushBulletDetail(weaponStruct.BulletData, weaponStruct.weaponStatus, this._refEntity.AimTransform, weaponStruct.SkillLV, new Il2CppSystem.Nullable_Unboxed<Vector3>(this._vSkillVelocity), true, default(Il2CppSystem.Nullable_Unboxed<int>), (CallbackObj)new System.Action<Il2CppSystem.Object>((Il2CppSystem.Object obj) =>
                                    {
                                        if (obj == null) { Plugin.Log.LogError("Hit Callback is null"); }
                                        else
                                        {
                                            this.RushSkillHitCB(obj);
                                        }
                                    }));
                                    ...
                                    Tangerine.Utils.Il2CppHelpers.FxManagerPlay(this.FX_1_00, this._refEntity.ModelTransform, Quaternion.identity);
                                    return;
                                }
                            }
                            break;
        ...
        private void RushSkillHitCB(Il2CppSystem.Object obj)
        {
            ...
            EnemyControllerBase enemyControllerBase = stageObjParam.tLinkSOB.Cast<EnemyControllerBase>();
            if (enemyControllerBase)
            {
                ...
                if (this._refEntity.IsLocalPlayer)
                {
                    ...
                    this._pRushTarget = enemyControllerBase.Cast<IAimTarget>();
